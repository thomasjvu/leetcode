...
// Explanation
// Use the binding this keyword to set the result property equal to the given value
// For each method, apply the calculator operation to the current result by the given value
// For the getResult() method, return this.result of the object.
